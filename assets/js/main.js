			...
			// Slide.
				var f = function() {
					...
					// Attach new slide.
						...
						// aboutButton.innerHTML = '<i class="material-icons">person_search </i> About Me & Resumé'
						// aboutButton.innerHTML += 'About Me & Resumé';
						// aboutButton.classList.add("button");
						// aboutButton.classList.add("large");
						// aboutButton.setAttribute("type", "button")
						// document.getElementById('footer').appendChild(aboutButton);
